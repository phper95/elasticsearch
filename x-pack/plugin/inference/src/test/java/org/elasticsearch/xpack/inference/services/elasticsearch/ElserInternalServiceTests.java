...
public class ElserInternalServiceTests extends ESTestCase {
    ...
    public static Model randomModelConfig(String inferenceEntityId, TaskType taskType) {
        return switch (taskType) {
            case SPARSE_EMBEDDING -> new org.elasticsearch.xpack.inference.services.elser.ElserInternalModel(
                inferenceEntityId,
                taskType,
    ...
    public void testParseConfigStrict() {
        ...
        settings.put(
            ...
            new HashMap<>(
                Map.of(
                    org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings.NUM_ALLOCATIONS,
                    1,
                    org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings.NUM_THREADS,
                    4,
                    "model_id",
                    ".elser_model_1"
                )
        ...
        var expectedModel = new org.elasticsearch.xpack.inference.services.elser.ElserInternalModel(
            "foo",
            TaskType.SPARSE_EMBEDDING,
            ElserInternalService.NAME,
            new org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings(1, 4, ".elser_model_1", null),
    ...
    private static ActionListener<Model> getModelVerificationListener(
        org.elasticsearch.xpack.inference.services.elser.ElserInternalModel expectedModel
    ) {
    ...
    public void testParseConfigStrictWithNoTaskSettings() {
        ...
        var expectedModel = new org.elasticsearch.xpack.inference.services.elser.ElserInternalModel(
            ...
            TaskType.SPARSE_EMBEDDING,
            ElserInternalService.NAME,
            new org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings(1, 4, ElserModels.ELSER_V2_MODEL, null),
            ElserMlNodeTaskSettings.DEFAULT
        );
                ...
                settings.put(
                    ...
                    new HashMap<>(
                        Map.of(
                            ...
                            org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings.NUM_THREADS,
                            4,
                            org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings.MODEL_ID,
                            ".elser_model_2"
                        )
                    )
                );
    ...
    public void testParseRequestConfig_DefaultModel() {
        var service = createService(mock(Client.class));
        {
            ...
            ActionListener<Model> modelActionListener = ActionListener.<Model>wrap((model) -> {
                assertEquals(
                    ".elser_model_2",
                    ((org.elasticsearch.xpack.inference.services.elser.ElserInternalModel) model).getServiceSettings().modelId()
                );
    ...
    public void testChunkInfer() {
        ...
        var model = new org.elasticsearch.xpack.inference.services.elser.ElserInternalModel(
            "foo",
            TaskType.SPARSE_EMBEDDING,
            "elser",
            new org.elasticsearch.xpack.inference.services.elser.ElserInternalServiceSettings(1, 1, "elser", null),
